...
serves it, at `/cyberspyke/`). No build step, no server, no accounts. Saves live in
localStorage.
...
css/cyberspyke.css       the whole look
js/
...
```sh
python3 tools/serve.py   # http://localhost:8137/cyberspyke/
```
