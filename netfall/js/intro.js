// NETFALL — cinematic intro: boot log, animated title screen, main menu.
...
const SOUND_KEY = 'netfall_sound';
const SEEN_KEY = 'netfall_seen_intro';
const SKIP_KEY = 'netfall_skip_intro';
...
export class Intro {
  ...
  aboutToReload() {
    return !window.crossOriginIsolated
      ...
      && !sessionStorage.getItem('netfall-coi-reload');
  }
