#!/usr/bin/env python3
"""Dev server for NETFALL: serves the repo root with the COOP/COEP headers
...
http://localhost:8137/ (game at /netfall/)."""
...
if __name__ == '__main__':
    with http.server.ThreadingHTTPServer(('127.0.0.1', PORT), Handler) as httpd:
        print(f'serving {ROOT} at http://localhost:{PORT}/ (game: /netfall/)')
        httpd.serve_forever()
