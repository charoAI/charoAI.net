# NETFALL — the `net` module, injected into every script's interpreter.
...
import _netfall_bridge as _bridge
...
def _make_module(host, argv):
    ...
    net.__doc__ = "NETFALL grid interface. See the Docs tab in-game for the full reference."
